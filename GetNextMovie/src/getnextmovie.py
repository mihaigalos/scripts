...
class MovieSeasonAndEpisodeExtractor(object):
    ...
    def readFile(self, kodi_log_file=kodi_log):
        last_movies = []
    ...
    def parseLastMovie(self):
        ...
        if m is not None:
          ...
          (self.season, self.episode, self.folder) = (m.group(2), m.group(4),m.group(1))
    ...
    def getNextSeasonFolder(self):
        ...
        next_season_folder_list = glob.glob(self.folder+"/../*"+potential_next_season+"*")
