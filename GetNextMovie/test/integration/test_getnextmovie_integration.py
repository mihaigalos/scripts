...
class FileFactory(unittest.TestCase):
    def createFolderStructure(self):
        ...
        location = os.path.join(self.kodi_test_folder,"media","Seagate_2TB","Series","Game.of.Thrones.S06.720p.BluRay.DD5.1.x264-CtrlHD")
        if(os.path.isdir(location)):
            shutil.rmtree(location)
        os.makedirs(location)

        location = os.path.join(self.kodi_test_folder,"media","Seagate_2TB","Series","Game.of.Thrones.S07.720p.HDTV.H264.RoSubbed-playTV")
        if(os.path.isdir(location)):
            shutil.rmtree(location)
        os.makedirs(location)
...
class NextSemanticSuggestionWorks(FileFactory):
    def test_whenFileExists(self):
        self.me.last_movie = self.kodi_test_folder+"/media/Seagate_2TB/Series/Game.of.Thrones.S06.720p.BluRay.DD5.1.x264-CtrlHD/Game.of.Thrones.S06E08.No.One.720p.BluRay.DD5.1.x264-CtrlHD.mkv"
        (season, episode, folder) = self.me.parseLastMovie()
        next_suggested_movie=self.me.getNextMovie()
        self.assertEqual(next_suggested_movie,self.kodi_test_folder+'/media/Seagate_2TB/Series/Game.of.Thrones.S06.720p.BluRay.DD5.1.x264-CtrlHD/Game.of.Thrones.S06E09.Battle.of.the.Bastards.720p.BluRay.DD5.1.x264-CtrlHD.mkv')

    def test_whenFileDoesntExists(self):
        self.me.last_movie = self.kodi_test_folder+"/media/Seagate_2TB/Series/Game.of.Thrones.S06.720p.BluRay.DD5.1.x264-CtrlHD/Game.of.Thrones.S06E09.Battle.of.the.Bastards.720p.BluRay.DD5.1.x264-CtrlHD.mkv"
        (season, episode, folder) = self.me.parseLastMovie()
        next_suggested_movie=self.me.getNextMovie()
        self.assertTrue("Game.of.Thrones.S07E01.720p.HDTV.H264.RoSubbed-playTV.mp4" in next_suggested_movie)
...
class NextSuggestionWorks(FileFactory):
    ...
    def test_whenTypicalFolder(self):
        ...
        self.assertEqual(next_suggested_movie,'/media/Seagate_2TB/Series/Game.of.Thrones.S06.720p.BluRay.DD5.1.x264-CtrlHD/Game.of.Thrones.S06E10')
    ...
    def test_whenTypicalFolderDot(self):
        ...
        (season, episode, folder) = self.me.parseLastMovie()
        next_suggested_movie=self.me.getPotentialNextMovie()
        self.assertEqual(next_suggested_movie,'/media/Seagate_2TB/Series/Game.of.Thrones.S06.720p.BluRay.DD5.1.x264-CtrlHD/Game.of.Thrones.S06.E10')
...
class ReadFileWorks(FileFactory):
    def test_whenTypical(self):
        self.me.readFile(self.kodi_test_folder+"/"+self.kodi_log_file)
        self.me.parseLastMovie()
        self.assertEqual(self.me.last_movie,self.kodi_test_folder+'/media/Seagate_2TB/Series/Game.of.Thrones.S06.720p.BluRay.DD5.1.x264-CtrlHD/Game.of.Thrones.S06E09.Battle.of.the.Bastards.720p.BluRay.DD5.1.x264-CtrlHD.mkv')
